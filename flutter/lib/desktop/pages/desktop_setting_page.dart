...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: 'À propos d\'Abcinfo-Remote', children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.abcinfo.ch');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://github.com/nanofjah/rustdesk');
                  },
                  child: Text(
                    'Code source (AGPLv3)',
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '© ${DateTime.now().toString().substring(0, 4)} Eric Miermon Informatique · basé sur RustDesk (© Purslane Tech, AGPLv3)\n$license',
